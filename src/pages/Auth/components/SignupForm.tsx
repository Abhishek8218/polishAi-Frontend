...
import { signupSchema, type TSignupFormData } from "../schemas/signup.schema";
...
export default function RegisterForm() {
  ...
  const {
    ...
    resolver: zodResolver(signupSchema),     // ← Connect Zod
    mode: "onChange",
  });
  ...
  const handleSignupSubmit = (data: TSignupFormData) => {
